...
function createSettingsContent(section) {
  ...
  o = section.option(
    ...
    _("Delay in milliseconds before reloading sentinel after interface UP"),
  );
  o.depends("enable_badwan_interface_monitoring", "1");
  o.default = "2000";
  o.rmempty = false;
  ...
  o.cfgvalue = function (section_id) {
    return uci.get("sentinel", section_id, "download_lists_via_proxy_section");
  };
  o.load = function () {
    const sections = this.map?.data?.state?.values?.sentinel ?? {};
