...
function createSectionContent(section) {
  ...
  o = section.option(
    ...
    "subscription_url",
    _("Subscription URL"),
    _("Your subscription URL. The content will be auto-decoded from base64 if needed.")
  );
  ...
  o = section.option(
    ...
    _("Select a predefined list for routing") +
      ' <a href="https://github.com/sentiox/allow-domains" target="_blank">github.com/sentiox/allow-domains</a>',
  );
