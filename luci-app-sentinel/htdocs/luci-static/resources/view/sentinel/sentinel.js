...
'require form';
'require network';
'require view.sentinel.configSection as configSection';
'require view.sentinel.diagnosticTab as diagnosticTab';
'require view.sentinel.additionalTab as additionalTab';
    ...
    async render() {
        document.head.insertAdjacentHTML('beforeend', `
            <style>
                ...
                #cbi-sentinel:has(.cbi-tab-disabled[data-tab="basic"]) #cbi-sentinel-extra {
                    display: none;
                }
            </style>
        `);

        const m = new form.Map('sentinel', '', null, ['main', 'extra']);
