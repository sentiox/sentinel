...
export const sentinel_LUCI_APP_VERSION = '__COMPILED_VERSION_VARIABLE__';
export const FAKEIP_CHECK_DOMAIN = 'fakeip.sentinel.fyi';
export const IP_CHECK_DOMAIN = 'ip.sentinel.fyi';
