...
export namespace Sentinel {
  // Available commands:
  // start                   Start sentinel service
  // stop                    Stop sentinel service
  // reload                  Reload sentinel configuration
  // restart                 Restart sentinel service
  // enable                  Enable sentinel autostart
  // disable                 Disable sentinel autostart
  // main                    Run main sentinel process
  ...
  // show_config             Display current sentinel configuration
  // show_version            Show sentinel version
  // show_sing_box_config    Show sing-box configuration
  // show_sing_box_version   Show sing-box version
  // show_system_info        Show system information
  // get_status              Get sentinel service status
  ...
  export interface GetSystemInfo {
    ...
    sentinel_latest_version: string;
