...
const syncDirs = [
  {
    local: path.resolve(process.env.LOCAL_DIR_FE ?? '../luci-app-sentinel/htdocs/luci-static/resources/view/sentinel'),
    remote: process.env.REMOTE_DIR_FE ?? '/www/luci-static/resources/view/sentinel',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_BIN ?? '../sentinel/files/usr/bin/'),
    remote: process.env.REMOTE_DIR_BIN ?? '/usr/bin/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_LIB ?? '../sentinel/files/usr/lib/'),
    remote: process.env.REMOTE_DIR_LIB ?? '/usr/lib/sentinel/',
  },
  {
    local: path.resolve(process.env.LOCAL_DIR_INIT ?? '../sentinel/files/etc/init.d/'),
